...
## 👩🏻‍💻 Who am I? (Breifly):
- 🏫: I am a `Graduate` from Department of CSE at University of Asia Pacific.
- 👩🏻‍🔬: I'm very passionate about `Research`, `AI`, `HCI`, `ML`, `DL`, `NLP` etc.
- 💻: I love writing `Scientific Content`, `Sci-Fi`.
